"""
Django settings for color-pal-backend project.
...
# solved the issue of not being able to login
...
ROOT_URLCONF = 'color-pal-backend.urls'
...
WSGI_APPLICATION = 'color-pal-backend.wsgi.application'
